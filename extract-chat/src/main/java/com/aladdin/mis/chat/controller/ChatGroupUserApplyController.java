...
/**
 * 聊天记录-两人对话 ChatGroupUserApplyService--- 
 * @author cles
 * @date 2024-08-30 00:19:39
*/
@RequestMapping("/chatGroupUserApply")
@Controller
public class ChatGroupUserApplyController  extends GlobalController<ChatGroupUserApply, ChatGroupUserApplyService> {
