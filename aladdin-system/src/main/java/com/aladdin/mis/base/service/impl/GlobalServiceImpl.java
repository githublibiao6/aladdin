...
import com.aladdin.common.db.qo.FieldCondition;
import com.aladdin.common.db.qo.OrderCondition;
import com.aladdin.common.db.bean.TableFieldInfo;
import com.aladdin.common.db.bean.TableInfo;
import com.aladdin.common.core.utils.JSONObjectUtil;
    ...
    private String getCondition(Condition condition, TableInfo table){
        ...
        list.forEach(t->{
            ...
            if(!columnCol.containsKey(field)){
                throw new MyException(":"+table.getClassName() + "不包含字" + field);
            }
