...
public abstract class BaseSqlMaker {
     ...
     * @version: 1.0.0
     */
    public String deleteSql(String tableName,String primaryKey, Long id){
     ...
     * @version: 1.0.0
     */
    public abstract String saveSql(String tableName,String primaryKey, List<TableFieldInfo> list);
